...
SELECT * FROM hashtagmovie.alugueis; -- 578 resultados
SELECT * FROM hashtagmovie.atores;   -- 145 resultados
SELECT * FROM hashtagmovie.atuacoes; -- 213 resultados
SELECT * FROM hashtagmovie.clientes; -- 123 resultados
SELECT * FROM hashtagmovie.filmes;   --  71 resultados
...
ORDER BY 
	estado 
DESC;  -- Atualmente 11 estados, faltam 16. 
...
SELECT COUNT(id_aluguel) as "Quantidade total de Aluguel"
FROM 
	alugueis;
...
-- Não contabilizou os valores NULL

SELECT COUNT(*) -- Agora contabilizando NULL 
FROM 
	alugueis; 
